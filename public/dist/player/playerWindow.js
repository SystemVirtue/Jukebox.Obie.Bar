...
class PlayerWindow {
    ...
    async initialize() {
        try {
            ...
            this.player.setOnErrorCallback((event) => {
            ...
            this.player.setOnStateChangeCallback((event) => {
    ...
    handlePlayCommand(videoId, title, artist) {
        if (!this.player)
            return;
...
//# sourceMappingURL=playerWindow.js.map