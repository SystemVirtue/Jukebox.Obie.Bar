...
class AdminPanel {
    constructor() {
        ...
        this.coinProcessor = null;
        this.activeSection = 'dashboard';
        this.connectionCheckerInterval = null;
        this.logEntries = [];
        this.mainJukeboxWindow = null;
        this.initializeUi();
        this.loadStoredData();
        ...
        try {
            ...
            if (storedSettings) {
                ...
                if (settings.idleTimeout) {
                    document.getElementById('idle-timeout').value = settings.idleTimeout.toString();
                }
                if (settings.transitionEffect) {
                    document.getElementById('transition-effect').value = settings.transitionEffect;
                }
        ...
        try {
            ...
            if (creditSettings) {
                ...
                if (settings.dollarOneValue) {
                    document.getElementById('dollar-one-value').value = settings.dollarOneValue.toString();
                }
                if (settings.dollarTwoValue) {
                    document.getElementById('dollar-two-value').value = settings.dollarTwoValue.toString();
                }
                if (settings.maxCredits) {
                    document.getElementById('max-credits').value = settings.maxCredits.toString();
                }
            }
        }
        catch (e) {
    ...
    setupEventListeners() {
        ...
        document.getElementById('add-credits-btn')?.addEventListener('click', () => {
            const input = document.getElementById('add-credits');
        ...
        document.getElementById('show-api-key')?.addEventListener('click', () => {
            ...
            if (apiKeyInput.type === 'password') {
                ...
                document.getElementById('show-api-key').textContent = 'Show';
            }
        });
     ...
     */
    sendCommandToJukebox(command, params = {}) {
     ...
     */
    updateCoinAcceptorStatus(connected = false) {
    ...
    saveCreditSettings() {
        try {
            const dollarOneValue = parseInt(document.getElementById('dollar-one-value').value, 10);
            const dollarTwoValue = parseInt(document.getElementById('dollar-two-value').value, 10);
            const maxCredits = parseInt(document.getElementById('max-credits').value, 10);
            const settings = {
                dollarOneValue,
                dollarTwoValue,
                maxCredits
    ...
    saveSystemSettings() {
        try {
            const idleTimeout = parseInt(document.getElementById('idle-timeout').value, 10);
    ...
    resetToDefaults() {
        // Reset form values
        document.getElementById('idle-timeout').value = '300';
        document.getElementById('transition-effect').value = 'fade';
        document.getElementById('dollar-one-value').value = '1';
        document.getElementById('dollar-two-value').value = '3';
        document.getElementById('max-credits').value = '255';
        // Clear password fields
        document.getElementById('admin-password').value = '';
        document.getElementById('confirm-password').value = '';
